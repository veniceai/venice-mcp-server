...
export class VeniceClient {
    ...
    get(path, headers, opts = {}) {
        return this.request(path, { method: 'GET', headers, ...opts });
    }
    /** POST request with JSON body. */
    post(path, json, headers, opts = {}) {
        return this.request(path, { method: 'POST', json, headers, ...opts });
    }
    /**
     ...
     */
    async postBinary(path, init, opts = {}) {
        const url = `${this.cfg.baseUrl}${path.startsWith('/') ? path : `/${path}`}`;
        const headers = {
            'User-Agent': `${this.cfg.serverName}/${this.cfg.serverVersion}`,
        };
...
//# sourceMappingURL=venice-client.js.map